...
const APP_PATH =  join(process.cwd(), './ApiDemos-debug.apk');
const SCREENSHOT_PATH =  join(process.cwd(), './screenshots/');
...
export const config = {
     ...
     */
     onPrepare: function (config, capabilities) {
        // if the dir exists, delete it - if not, create it
        if (fs.existsSync(config.screenshotPath)){
            fs.rmSync(config.screenshotPath, { recursive: true, force: true });
