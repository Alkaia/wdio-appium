...
export default class Dialog extends Page{
     ...
     * Define Elements
     */
    get appBtn() { return $('~App'); } // accessibility ID
    // get appBtn() { return $('//android.widget.TextView[@content-desc="App"]'); } // XPath
    ...
    _weekdayCheckbox(index) { return $(`//android.widget.CheckedTextView[@index="${index}"]`); }
